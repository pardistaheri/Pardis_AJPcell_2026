% Aconitase parameter estimation without regulation
% CIT = ICIT
% A - CIT; B - ICIT; 
%
...
% Data used for parameter estimations were obtained from Mansilla et al 2023
...
K_A = 950e-06; %CIT binding constant(M)
K_B = 1e-06; %ICIT binding constant(M)
Vmaxf = 10; %Maximum forward reaction rate(mmol/min)
