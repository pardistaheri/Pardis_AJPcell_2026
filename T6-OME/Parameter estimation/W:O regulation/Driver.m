% OME parameter estimation forward reaction w/o regulation
% AKGe + MALm = AKGm + MALe
% A - AKGe; B - MALm; C - OXAe; D - MALm;
%
...
% Data used for parameter estimations were obtained from Indiveri et al. 1991.
% Copyright:
...
K_A = 0.2e-03; %AKGe Binding constant (M)
K_B = 1.4e-03; %MALm Binding constant (M)
