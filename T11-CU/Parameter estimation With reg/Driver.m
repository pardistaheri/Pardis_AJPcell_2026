...
K_C = 0.8e-02; %Mg binding constant(M)
K_E = 0.2e-02; %Pi binding constant(M)
Tmax = 3.1057560e-7; %Maximum transport rate(mmol/s)
 %
   
   
p0 = [K_C,K_E, Tmax];  %Binding Constants initial guess
