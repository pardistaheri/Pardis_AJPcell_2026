% ANT parameter estimation forward reaction w/o regulation
% ADPe + ATPm = ADPm + ATPe
% A - ADPe; B - ATPm; C - ADPm; D - ATPe ;
...
% Data used for parameter estimations were obtained from Metelkin et al. 2006.
% Copyright:
...
K_A = 7.3375e-04; %ADP_e (M)
K_B = 1.5113e-05 ; %ATP_m(M)
K_C = 7.3375e-04; %ADP_m (M)
K_D = 1.5113e-05 ; %ATP_e(M)
Tmaxf = 0.2942e+01; %Maximum forward reaction rate(mmol/min)
 %
   
p0 = [K_A, K_B,K_C, K_D, Tmaxf];  %Binding Constants initial guess
