% Glutamate Oxaloacetate Transaminase (Aspartate Transaminase) parameter estimation without regulation
% ASP + AKG =  GLU + OXA
...
% Data used for parameter estimations were obtained from Hensen et al 1964
...
K_A = 3480*10^-3; %ASP binding constant(M)
K_B = 430*10^-3; %AKG binding constant(M)
K_C = 8400*10^-6; %GLU binding constant(M)
K_D = 5*10^-6; %OXA binding constant (M)
Vmaxf = 0.00005; %Maximum forward reaction rate(mmol/min)
