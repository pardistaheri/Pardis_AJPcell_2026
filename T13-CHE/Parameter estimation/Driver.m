% CHE binding constants' estimation and biochemical reaction fit
% Cam + 2He -> Cae + 2Hm
% the flux for CHE transporter in this model was devolped in Audi & Dash lab
...
K_A = 4.8e-4; %Ca Binding constant (M)
K_C = 4.8e-4; %Ca Binding constant (M)
Tmax = 4.7e-4; %Maximum transport rate(mmol/min)
   
p0 = [K_A, K_C, Tmax];  %Binding Constants initial guess
