% Isocitrate dehydrogenase parameter estimation with pH regulation
...
% Data used for parameter estimations were obtained from Willson et al 1980
% Copyright:
...
p0 = [K_H, Vmaxf];  %Binding Constants initial guess
