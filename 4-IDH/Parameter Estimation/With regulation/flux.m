...
K_A=4.47e-04; %ICIT binding constant 
K_B=7.21e-01; %NAD binding constant
K_C=4.46e-04; %AKG binding constant
K_D=3.13e-06; %NADH binding constant
...
K_A_prime=K_A*(1/(1+(ATP/K_ATP)+(ADP/K_ADP)));

deno=(1+(A/K_A_prime)^n)*(1+B/K_B+D/K_D)*(1+C/K_C)*(1+E/K_E);  
J_IDH =Vmaxf_prime/(K_A_prime)^n/K_B*((A)^n*B-C*D*E/Keq)/deno;
end