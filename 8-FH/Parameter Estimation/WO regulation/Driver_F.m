% Fumarate Hydratase parameter estimation forward reaction w/o regulation
% FUM + H2O = MAL
% A - FUM; B - MAL;
...
K_A = 44*10^-6; %FUM binding constant(M)
Vmaxf = 350; %Maximum forward reaction rate(mmol/min)

p0 = [K_A, Vmaxf];  %Binding Constants initial guess
...
for i = 1:numIters
    ...
    fmincon(@Error_F,p0,[],[],[],[],lbp,ubp,[],options);
