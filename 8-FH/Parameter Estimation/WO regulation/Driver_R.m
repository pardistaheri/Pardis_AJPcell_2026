% Fumarase parameter estimation reverse reaction w/o regulation
% FUM +H2O  = MAL
% A - FUM; B - MAL;
...
K_B = 195*10^-6; %MAL binding constant(M)
Vmaxf = 15; %Maximum forward reaction rate(mmol/min)

p0 = [K_B, Vmaxf];  %Binding Constants initial guess
