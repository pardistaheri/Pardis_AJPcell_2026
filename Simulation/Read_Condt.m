...
addpath('/Users/pardis/Library/CloudStorage/OneDrive-mcw.edu/Computational_Model_Pardis/Lung_mito_model_norm_HT_HS/Normoxia/Simulation/Enzyme');
load Model_Params
p.org=1; % organ 
p.Algt=1; % algorithm 
