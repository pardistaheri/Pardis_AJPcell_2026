% Pyruvate Dehydrogenase parameter estimation of kinase enzyme
% PYR + COA + NAD + H2O = ACOA + CO2 + NADH + H+
% A - PYR; B - COA; C - NAD; D - ACOA; E - CO2; F - NADH;
%
% NOTE: The following regulation was adopted from the PDH model developed
% by Bazil et al 2010 published in Public Library of Science 
% Data used for parameter estimations were obtained from Hucho et al 1972
...
K_ATP=4.3997800e-05;
K_ADP=2.5621646e-03;
K_iPYR=1.1942413e-02;
 
p0 = [K_H, K_ATP, K_ADP, K_iPYR];  %Binding Constants initial guess
