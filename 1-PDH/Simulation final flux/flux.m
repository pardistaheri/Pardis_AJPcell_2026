...
KE=1e-05; %M CO2 binding constant
KF=3.52e-5; % M NADH
...
KHP=9.66e-8; % M H+
KCa=1.06e-4; % M Ca2+
bCa=0.26; % Ca2+ activation constant

Vmaxf=19.4407170e-05;
%%% Concentration
A=Conc(1);
B=Conc(2);
C=Conc(3);
D=0;
E=1.32e-5; % CO2 is a constant (No ODE for CO2)  
F=0;
Hm=10^(-pH_m);
