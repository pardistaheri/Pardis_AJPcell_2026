% Citrate synthase parameter estimation without regulation
% ACOA + OXA = COA + CIT + 2H+
...
% Data used for parameter estimations were obtained from Matsuoka et al 1973
% Copyright:
...
K_A = 2.28e-06; %ACoA binding constant(M)
K_B = 1.41e-06; %OXA binding constant(M)
K_C = 8.59e-05; %CoA binding constant(M)
K_D = 5.15e-03; %CIT binding constant(M)
Vmaxf = 0.126; %Maximum forward reaction rate(mmol/min)
