% Citrate synthase parameter estimation with pH regulation
% ACOA + OXA = COA + CIT + 2H+
...
% Data used for parameter estimations were obtained from Shepherd et al 1969
% Copyright:
...
K_H = 1e-07; %Proton binding constant (M)
