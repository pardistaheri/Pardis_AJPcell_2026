% NHE binding constants' estimation and biochemical reaction fit
% Nam + He -> Nae + Hm
...
K_A = 25e-3; %Na Binding constant (M)
K_B = 10^-8.5; %H binding constant(M)
% K_C = 25e-3; %Na Binding constant (M)
% K_D = 10^-8.5; %H binding constant(M)
Tmax = 12e-06; %Maximum transport rate(mmol/min)
%nh = 3;
 %
