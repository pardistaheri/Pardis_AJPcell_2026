% Malate Dehydrogenase parameter estimation without regulation
% MAL + NAD = OXA + NADH + H 
...
% Data used for parameter estimations were obtained from Heyde et al 1967
...
K_A = 8.7711043e-04; %MAL binding constant(M)
K_B = 1.2573174e-04; %NAD binding constant(M)
K_C= 4.8900686e-05; %OXA binding constant(M)
K_D = 3.4700496e-05; %NADH binding constant(M)
Vmaxf = 1.3909237e-04; %Maximum forward reaction rate(mmol/min)
