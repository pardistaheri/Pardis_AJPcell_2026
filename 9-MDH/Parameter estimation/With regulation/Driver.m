% Malate Dehydrogenase parameter estimation with ATP, ADP, and AMP regulation
% MAL + NAD = OXA + NADH + H 
...
% Data used for parameter estimations were obtained from Oza et al 1972
...
K_ATP = 8.7266430e-04  ; %ATP binding constant (M)
K_ADP = 1.4837816e-03 ; %ADP binding constant (M)
K_AMP = 1.8864817e-03 ; %AMP binding constant (M)
Vmaxf = 1.0587798e-01; %Maximum forward reaction rate(mmol/min)

p0 = [K_ATP,K_ADP,K_AMP, Vmaxf];  %Binding Constants initial guess
