% GAE parameter estimation forward reaction with Ca regulation
% ASPm + GLUe = ASPe + GLUm
...
K_Ca = 4.5e-03; %Ca Binding constant (M)
Tmax =  14.4e-06; %Maximum transport rate(mmol/s)
   
p0 = [K_Ca,Tmax];  %Binding Constants initial guess
