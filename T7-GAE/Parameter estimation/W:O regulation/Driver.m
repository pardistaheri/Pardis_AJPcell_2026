% GAE parameter estimation forward reaction w/o regulation
% ASPm + GLUe = ASPe + GLUm
% A - ASPm; B - GLUe; C - ASPe; D - GLUm;
%
...
% Data used for parameter estimations were obtained from Murphy et al. 1979.
% Copyright:
...
K_A = 4.9865778e-03; %ASP Binding constant (M)
K_B = 7.7393691e-03; %GLU Binding constant (M)
Tmax = 3.9244186e-07; %Maximum transport rate(mmol/s)
