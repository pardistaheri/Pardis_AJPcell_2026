% ComplexI parameter estimation reaction w/o regulation
...
% Data used for parameter estimations were obtained from Hano et al 2003
% Copyright:
...
K_C = 428*1e-6; %NAD (M)
K_D = 519*1e-6; %UQH2 (M)
Vmaxf = 9.8*1e-5; %Maximum forward reaction rate(mmol/min)
